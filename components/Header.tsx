    ...
    return (
        <header className="z-[100] px-4 sm:px-8 py-3 flex justify-between items-center bg-black/40 backdrop-blur-3xl border-b border-white/5">
            <div className="flex items-center gap-4">
                <Link href="/" className="group flex flex-col items-start leading-[0.8]">
                    <motion.div
                    ...
                    >
                        <span
                            className="text-xl sm:text-2xl font-black tracking-tighter sm:tracking-widest text-transparent bg-clip-text bg-gradient-to-r from-white via-purple-400 to-white"
                            style={{ fontFamily: 'var(--font-orbitron)' }}
                        >
                            SOLNOMO
                        </span>
                        <span className="text-[7px] sm:text-[8px] font-bold tracking-[0.2em] text-purple-400/80 uppercase mt-0.5 ml-0.5">
                            by MagicBlock
                        </span>
                    </motion.div>
                </Link>
